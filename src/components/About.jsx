...
const About = () => {
  return (
    <section id="about" className="py-24 px-6 md:px-12 max-w-6xl mx-auto min-h-[100vh] flex flex-col justify-center">
      ...
      {/* Heading */}
      <h2 className="font-sans text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#121110] dark:text-[#f6f4eb] mb-16 leading-[1.1]">
        What I build instead of just writing a resume.
      </h2>

      {/* Narrative Split - Razorpay style comparison */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 mb-16 items-start border-t border-[#121110]/10 dark:border-[#f6f4eb]/20 pt-12">
        {/* Left Column */}
        <div className="space-y-6">
          <h3 className="font-sans text-sm tracking-[0.2em] text-[#ff8c00] uppercase font-bold mb-8">
            THE RESUME
          </h3>
          <ul className="space-y-4 font-mono text-lg md:text-xl text-gray-600 dark:text-gray-400">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 font-mono text-lg md:text-xl text-[#121110] dark:text-[#f6f4eb]">
      ...
      <p className="font-serif text-2xl md:text-3xl text-gray-700 dark:text-gray-300 italic mt-8">
